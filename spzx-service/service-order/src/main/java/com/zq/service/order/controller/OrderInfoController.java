package com.zq.service.order.controller;
...
public class OrderInfoController {
    ...
    public Result trade(@RequestHeader("token") String token) {
        TradeVo tradeVo = orderInfoService.getTrade(token);
